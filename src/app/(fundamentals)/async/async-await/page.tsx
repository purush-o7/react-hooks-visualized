...
import { ExampleParallelAwait } from "./_components/example-parallel-await";
...
export default function AsyncAwaitPage() {
  return (
    <div className="max-w-3xl space-y-12">
      ...
      <ScrollReveal>
        <section className="space-y-4">
          <h2 className="text-2xl font-bold">Parallel vs Sequential</h2>
          <p className="text-muted-foreground">
            When awaits don&apos;t depend on each other, run them in parallel
            with <code className="text-foreground">Promise.all</code> — don&apos;t
            make them wait in line:
          </p>
          <ExampleParallelAwait />
        </section>
      </ScrollReveal>
