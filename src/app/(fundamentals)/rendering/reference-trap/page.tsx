...
import { ExampleHoistedDefaults } from "./_components/example-hoisted-defaults";
...
export default function ReferenceTrapPage() {
  return (
    <div className="max-w-3xl space-y-12">
      ...
      <ScrollReveal>
        <section className="space-y-4">
          <h2 className="text-2xl font-bold">Fix: Hoist Default Props</h2>
          <p className="text-muted-foreground">
            Default parameter values with{" "}
            <code className="text-foreground">= {"{}"}</code> create new
            references too. Hoist them outside the component:
          </p>
          <ExampleHoistedDefaults />
        </section>
      </ScrollReveal>
